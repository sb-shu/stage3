<?php
  ...
  // Check if "user" is set and that it exists in the database.
  if(isset($_GET["user"]) && DoesUserExist($_GET["user"]) != null){
    $user = GetUser($_GET["user"]);
    // See bottom of the page for what happens when "user" is not set.
?>
